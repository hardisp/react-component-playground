...
export default function Select({
  ...
  return (
    <>
      ...
      >
        <SelectTrigger>
          <div className={twMerge('flex min-h-10 w-full flex-wrap items-center rounded-xs bg-gray-200 px-2 py-1 text-sm shadow-xs focus-within:ring-2 focus-within:ring-blue-500 justify-between gap-2', outline ? 'border border-gray-300 bg-transparent' : 'border border-transparent')}>
